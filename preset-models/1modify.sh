...
#修改主机名
sed -i 's/OpenWrt/h3c_tx1801-plus/g' package/base-files/files/bin/config_generate
#修改型号显示
sed -i 's/h3c_tx1801-plus/h3c_tx1801-plus/g' target/linux/ramips/dts/mt7621_h3c_tx1801-plus.dts
